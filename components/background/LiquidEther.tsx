...
interface LiquidEtherProps {
    ...
    onLoad?: () => void;
    color0?: string; // Kept for compatibility if passed, though unused in logic
    color1?: string;
    color2?: string;
}
...
`;
        ...
        class ExternalForce extends ShaderPass {
            ...
            update(props?: any) {
                ...
                if (this.mouse) {
                    const material = this.mouse.material as THREE.ShaderMaterial;
        ...
        class Simulation {
            ...
            getFloatType() {
                // Simple check, in real app might need better support check
        ...
        class Output {
            ...
            constructor() {
                this.simulation = new Simulation({}); // Initial options will be overridden
                this.scene = new THREE.Scene();
                this.camera = new THREE.Camera();
                this.init();
            }
        ...
        class WebGLManager {
            ...
            constructor(props: any) {
                ...
                // Bind to window for global resize events might be safer, but user code does this
            ...
            init() {
                if (Common.renderer && this.props.$wrapper) {
                    ...
                    const existing = this.props.$wrapper.querySelector('canvas');
                    if (!existing) {
        ...
        // Fix for potential multiple initializations
        if (webglRef.current) {
